...
public class FifthHomeWork {
    public static void main(String[] args) {
        ...
        for(int a=word.length()-1; a>=0; a--) {
            System.out.println(word.charAt(a));                 // also can use substring method - word.substring(a, a+1)
        }
        ...
        for(int i=abr.length-1; i>=0;  i--) {
            abr[i]=abr[i].substring(0,1).toUpperCase();
            System.out.println("Abbreviation :" + abr[i]);
        }
        ...
        String[] abr2 = msg2.toUpperCase().split(" ");
        for(int d=abr2.length-1; d>=0; d--) {
            abr2[d]=abr2[d].substring(0,1);
            System.out.println("Abbreviation :" + abr2[d]);
        }
        ...
        for(int e=abr3.length-1; e>=0; e--) {
            abr3[e] =abr3[e].substring(0,1);
            System.out.println("Abbreviation :" + abr3[e]);
        }

        for(String abbr: abr3) {
